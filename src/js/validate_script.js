    ...
    $.ajax({
        ...
        success : function(data){
            if ( data.trim() == 'true') {
                ...
                if ( thisForm.data("form") == "program" ) {
                    yaCounter43197719.reachGoal('1f');
                }
                if ( thisForm.data("form") == "test" ) {
                    yaCounter43197719.reachGoal('Test');
                    var testCount = $('.test-count').text();
                    testCount++;
                    $('.test-count').text(testCount);
                    console.log(testCount)
                }
                if ( thisForm.data("form") == "results" ) {
                    yaCounter43197719.reachGoal('result');
                }
                if ( thisForm.data("form") == "questions" ) {
                    yaCounter43197719.reachGoal('Vopros');
                }
                if ( thisForm.data("form") == "idividual" ) {
                    yaCounter43197719.reachGoal('PoslForma');
                }
...
$(document).ready(function(){
   ...
   validate('.program-form', {submitFunction:validationCall});
   validate('.test-form', {submitFunction:validationCall});
   validate('.idividual-form', {submitFunction:validationCall});

   validate('.call-form', {submitFunction:validationCall});
   validate('.bundle-form', {submitFunction:validationCall});
   validate('.questions-form', {submitFunction:validationCall});
   validate('.feedback-form', {submitFunction:validationCall});
